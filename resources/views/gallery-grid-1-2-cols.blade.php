...
<html lang="en-US">
	<head>
		...
		<title>Gallery Grid 1-2 Cols - Tilia </title>
		<!-- Google Fonts -->
	...
	<body class="home">
		...
		<div class="top-single-bkg top-single-gallery">
			...
			<div class="inner-desc">
				<div class="container">
					<h1 class="display-2 single-post-title">Gallery Grid 1-2 Cols</h1>
					<span class="post-subtitle">Botanic Garden Photo Shoot</span>
				</div>
			</div>
		</div>
		<!-- /TOP HEADER IMAGE -->
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="portfolio-grid gallery-holder-grid gallery-grid12cols">
								...
								<div class="item-portfolio item-12cols gallery-post"> <a href="images/portfolio/gal-grid/gal-12-01.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-12-01.jpg" alt="" title="" width="1350" height="1500"> </a>
								</div><!-- /item-portfolio -->

								<div class="item-portfolio item-12cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-01.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-01.jpg" alt="" title="" width="750" height="500"> </a>
								</div><!-- /item-portfolio -->

								<div class="item-portfolio item-12cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-02.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-02.jpg" alt="" title="" width="750" height="500"> </a>
								</div><!-- /item-portfolio -->

								<div class="item-portfolio item-12cols gallery-post"> <a href="images/portfolio/gal-grid/gal-12-02.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-grid/gal-12-02.jpg" alt="" title="" width="1350" height="1500"> </a>
								</div><!-- /item-portfolio -->

								<div class="item-portfolio item-12cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-04.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-04.jpg" alt="" title="" width="750" height="500"> </a>
								</div><!-- /item-portfolio -->

								<div class="item-portfolio item-12cols gallery-post"> <a href="images/portfolio/gal-masonry/gal-masonry-06.jpg" class="lightbox" title=""> <img class="img-fluid" loading="lazy" src="images/portfolio/gal-masonry/gal-masonry-06.jpg" alt="" title="" width="750" height="500"> </a>
								</div><!-- /item-portfolio -->
