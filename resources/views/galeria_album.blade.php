...
<head>
    ...
    <title>Espaço Kaká & Marcos - {{$evento->nome_evento}}</title>
    <!-- Google Fonts -->
...
<div class="top-single-bkg top-single-gallery">
    <div class="topsingleimg"> <img src="{{asset($banner)}}" alt="" width="1920" height="1080"></div>
    <div class="inner-desc">
        <div class="container">
            <h1 class="display-2 single-post-title">{{$evento->nome_evento}}</h1>
            <span class="post-subtitle">{{$evento->tipo_evento}}</span>
        </div>
    </div>
</div>
<!-- /TOP HEADER IMAGE -->
...
<div id="wrap-content" class="page-content page-gallery-content">
    ...
    <div class="gallery-container">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="portfolio-grid gallery-holder-grid gallery-grid4cols">
                        @foreach($galeria as $key => $data)
                            <div class="item-portfolio item-4cols gallery-post">
                                <a href="{{asset($data->image_url)}}" class="lightbox" title="">
                                    <img class="img-fluid" loading="lazy" src="{{asset($data->image_url)}}" alt="" title="" width="750" height="750">
                                </a>
                            </div><!-- /item-portfolio -->
                        @endforeach
                    </div>
...
<div id="footer-instagram">
    <ul class="instagram-pics instagram-size-small">
        @foreach($fotos as $key => $data)
            <li class=""><a href="#" target="_blank" class=""><img loading="lazy" src="{{asset($data->image_url)}}" alt=""/></a></li>
        @endforeach
    </ul>
</div>
<footer>
